...
face1 = face_recognition.load_image_file("1.jpg")
...
face3 = face_recognition.load_image_file("3.png")
...
def main():
    ...
    print("OK")
    while True:
        serial_input = ser.readline().strip().decode('utf-8')
        print(serial_input)
        if serial_input == "SYN":
            ser.write(b'SYNACK\n')
        elif serial_input == "ACK":
            break
    print("Connected")
